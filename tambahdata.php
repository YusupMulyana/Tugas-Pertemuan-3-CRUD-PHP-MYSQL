...
crossorigin="anonymous">
 <title>Tambah Pelanggan Hotel</title>
 </head>
 <body>
 <div class="alert alert-success text-right"
role="alert" > <h2>DATA PELANGGAN HOTEL FOX</h2>
 </div>
 <h1 class="ml-5">Tambah Pelanggan Hotel</h1>
 <form method="post"
action="prosestambahdata.php" class="ml-5">
 <div class="form-group row">
 <label for="nama" class="col-sm-1 col-formlabel">NAMA</label>
 <div class="col-sm-3">
 <input type="text" name="NAMA_PELANGGAN" class="formcontrol" placeholder="Masukkan text">
 </div>
 </div>
 <div class="form-group row">
 <label for="alamat" class="col-sm-1 col-formlabel">ALAMAT</label>
 <div class="col-sm-3">
<input type="text" name="ALAMAT" class="form-control" placeholder="Masukkan text">
 </div>
 </div>
 <div class="form-group row">
 <label for="spesialis" class="col-sm-1 col-formlabel">SEWA </label>
 <div class="col-sm-3">
 <input type="text" name="SEWA" class="formcontrol" placeholder="Masukkan text">
 </div>
 </div>
<button type="submit" class="btn btn-primary mb-1
mt-1 ml-0 mr-0" >Kirim</button>
<a href="index.php" class="btn btn-primary mb-1 mt-1
ml-0"><i class="fas fa-user-plus mr-0"></i>Data Pelanggan Hotel</a>
</form>
 <!-- Optional JavaScript -->
