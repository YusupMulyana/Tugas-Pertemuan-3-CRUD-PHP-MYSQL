...
$id=$_GET['id'];
$query="SELECT * FROM id_pegawai WHERE NO_KTP=" . $id;
...
<h2>DATA PELANGGAN HOTEL FOX</h2>
 ...
 <h1 class="ml-5">Ubah Data Pelanggan Hotel</h1>
...
value="<?php echo $id ?>" >
 <label for="NAMA_PELANGGAN" class="col-sm-1 col-form-label">NAMA_PELANGGAN</label>
 <div class="col-sm-3">
...
value="<?php echo $data['ALAMAT'] ?>" >
 ...
 <div class="form-group row">
 <label for="SEWA" class="col-sm-1 col-formlabel">SEWA</label>
 <div class="col-sm-3">
 <input type="text" name="SEWA" class="formcontrol" value="<?php echo $data['SEWA'] ?>" >
 </div>
 </div>
<button type="submit" class="btn btn-primary mb-1 mt-1 ml-0
mr-0" >Kirim</button>
<a href="index.php" class="btn btn-primary mb-1 mt-1 ml0"><i class="fas fa-user-plus mr-0"></i>Data Pelanggan Hotel</a>
</form>
<?php } ?>
 <!-- Optional JavaScript -->
